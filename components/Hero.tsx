...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden noise-overlay">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full pt-32 pb-20">
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-8xl font-extrabold tracking-[-0.03em] leading-[0.9] mb-8">
            ...
            <br />
            <span className="text-on-surface-variant">{t("hero.headline3")}</span>
            <br />
            {t("hero.headline4")}
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <a href="#quote" className="inline-flex items-center gap-2 bg-primary text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-primary-light hover:scale-[1.02] transition-all duration-300 active:scale-95 shadow-xl shadow-primary/20">
              {t("hero.cta1")}
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </a>
            <a href="#services" className="inline-flex items-center gap-2 border border-outline-variant/30 text-on-surface px-8 py-4 rounded-lg font-bold text-lg hover:bg-white/5 transition-all duration-300">
              {t("hero.cta2")}
            </a>
          </div>
