        ...
        <div ref={formRef} className="glass-card border border-outline-variant/10 rounded-2xl p-8 lg:p-12 shadow-2xl shadow-black/20">
          {submitted ? (
            <div className="text-center py-12">
              <div className="w-16 h-16 rounded-full bg-primary/20 flex items-center justify-center mx-auto mb-6 animate-bounce">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" required placeholder={t("quote.name.ph")} className="w-full bg-surface-container-highest/80 border border-outline-variant/10 focus:border-primary focus:ring-1 focus:ring-primary rounded-lg px-4 py-3.5 text-on-surface placeholder:text-on-surface-variant/40 transition-all outline-none focus:translate-y-[-1px] focus:shadow-lg focus:shadow-primary/5" />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="tel" required placeholder={t("quote.phone.ph")} className="w-full bg-surface-container-highest/80 border border-outline-variant/10 focus:border-primary focus:ring-1 focus:ring-primary rounded-lg px-4 py-3.5 text-on-surface placeholder:text-on-surface-variant/40 transition-all outline-none focus:translate-y-[-1px] focus:shadow-lg focus:shadow-primary/5" />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea rows={4} required placeholder={t("quote.details.ph")} className="w-full bg-surface-container-highest/80 border border-outline-variant/10 focus:border-primary focus:ring-1 focus:ring-primary rounded-lg px-4 py-3.5 text-on-surface placeholder:text-on-surface-variant/40 transition-all outline-none resize-none focus:translate-y-[-1px] focus:shadow-lg focus:shadow-primary/5" />
              </div>
              <button type="submit" className="w-full bg-primary text-white py-4 rounded-lg font-bold text-lg hover:bg-primary-light transition-all duration-300 hover:scale-[1.01] active:scale-[0.99] shadow-xl shadow-primary/20 hover:shadow-2xl hover:shadow-primary/30">{t("quote.submit")}</button>
