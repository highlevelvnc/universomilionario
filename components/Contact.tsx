        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <a href="tel:+351964456526" className="flex items-center gap-4 bg-surface-container-high rounded-xl p-5 border border-outline-variant/8 hover:border-primary/20 transition-all group">
              ...
              <a href="https://wa.me/351964456526?text=Ol%C3%A1%2C%20gostaria%20de%20pedir%20um%20or%C3%A7amento." target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 bg-surface-container-high rounded-xl p-5 border border-outline-variant/8 hover:border-green-500/30 transition-all group">
